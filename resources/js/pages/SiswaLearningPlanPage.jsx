        ...
        <DashboardLayout title="Rencana Belajar" user={session?.user} navigation={siswaNavigation} onLogout={onLogout} profileHref="/siswa/profil">
            <div className="space-y-6">
                <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-gradient-to-br from-slate-900 via-blue-900 to-cyan-800 px-6 py-8 text-white shadow-2xl shadow-slate-950/20 lg:px-8">
                    <p className="text-sm font-medium uppercase tracking-[0.3em] text-indigo-300">Rencana Belajar</p>
                    <h3 className="mt-2 text-2xl font-semibold text-slate-100">Kelola kartu belajar pribadi</h3>
                    <p className="mt-2 text-sm text-slate-300">Menu ini khusus untuk menambah dan melihat target belajar siswa tanpa menumpuk di dashboard.</p>
