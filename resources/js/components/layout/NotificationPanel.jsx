...
export default function NotificationPanel() {
    ...
    return (
        <div className="relative mr-4" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute right-[-75px] sm:-right-2 mt-3 w-[320px] max-w-[92vw] sm:w-80 origin-top-right rounded-2xl bg-white shadow-2xl ring-1 ring-slate-900/5 focus:outline-none z-50">
